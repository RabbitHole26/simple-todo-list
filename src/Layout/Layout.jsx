    ...
    <div className={`flex flex-col min-h-screen ${isDarkMode ? '' : 'lightMode'}`}>
      ...
      {error &&
        <div className="fixed inset-0 overflow-y-auto flex items-center justify-center z-50">
          <div className={`lightModeBorder w-[350px] boxShadow border rounded-md p-5 mb-8 flex flex-col gap-2 ${isFadingOut ? 'animate-fadeOut' : 'animate-fadeIn'} ${isDarkMode ? 'bg-stone-800' : 'bg-neutral-400'}`}>
